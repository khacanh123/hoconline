...
<div class="container header">
   ...
   @endif
			<h4>Vui lòng điền thông tin</h4>
				...
				<div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon2">Họ và tên</span>
				  </div>
				  <input type="text" class="form-control" aria-label="Password" name="full_name"  aria-describedby="basic-addon2">
				</div>
                <div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon2">Mật khẩu</span>
				  </div>
				  <input type="password" class="form-control" aria-label="Password" name="password" aria-describedby="basic-addon2">
				</div>
                <div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon2">Nhập lại mật khẩu</span>
				  </div>
				  <input type="password" class="form-control" aria-label="Password" name="re_password" aria-describedby="basic-addon2">
				</div>
                <div class="input-group mb-3">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon2">Số điện thoại</span>
				  </div>
				  <input type="text" class="form-control" aria-label="Password" name="telephone" aria-describedby="basic-addon2">
				</div>
				<div class="input-group mb-3">
					<button type="submit" class="btn btn-default">Đăng ký tài khoản</button>
				</div>
                <div class="input-group mb-3">
					<button type="button" class="btn btn-default login"> Về trang đăng nhập</button>
				</div>
	</form>
			</div>
		</div>
